...
To ensure that the meta-analysis are not influenced by the results of the replications, we only considermeta-analysis published before the replications took place. 
