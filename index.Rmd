...
The PEESE method brings the bias further down by 40\%.
The other criteria tell a similar story.
This data makes the PEESE estimator the best estimator so far to estimate true treatment effects using the published record.
